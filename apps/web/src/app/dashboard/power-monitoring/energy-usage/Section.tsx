// app/(dashboard)/dashboard/power-monitoring/energy-usage/Section.tsx
"use client";
...
export default function EnergyUsageSection({ device }: { device?: Location }) {
  ...
  // const energyKWh = (EnergyUsage * 230) / 1000;
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col items-center w-full md:w-1/2 bg-[#032d7a] rounded-2xl p-6">
          ...
          <div className="text-white px-3 py-1 rounded mt-[-81px] text-sm font-light">Energy Usage</div>
          <div className="bg-gray-200 text-black px-3 py-1 rounded mt-2 font-bold">{EnergyUsage} A</div>
        </div>
          ...
          <ResponsiveContainer width="100%" height={250}>
            <AreaChart data={data} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
              ...
              <YAxis
                ...
                label={{ value: "Energy Usage", angle: -90, position: "insideLeft", fill: "#fff", dy: 50 }}
              />
              <Tooltip
                contentStyle={{
